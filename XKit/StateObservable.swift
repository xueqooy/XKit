...
public final class StateObservableObjectPublisher: Publisher {
    ...
    public final func receive<S>(subscriber: S) where S: Subscriber, Never == S.Failure, Void == S.Input {
...
public struct StateObject<Value: StateObservableObject> {
    ...
    public static subscript<T>(_enclosingInstance instance: T, wrapped _: ReferenceWritableKeyPath<T, Value>, storage storageKeyPath: ReferenceWritableKeyPath<T, StateObject>) -> Value {
        get {
...
public struct State<Value> {
    ...
    public static subscript<T>(_enclosingInstance instance: T, wrapped _: ReferenceWritableKeyPath<T, Value>, storage storageKeyPath: ReferenceWritableKeyPath<T, State>) -> Value {
        get {
...
public struct EquatableState<Value: Equatable> {
    ...
    public static subscript<T>(_enclosingInstance instance: T, wrapped _: ReferenceWritableKeyPath<T, Value>, storage storageKeyPath: ReferenceWritableKeyPath<T, EquatableState>) -> Value where Value: Equatable {
        get {
            instance[keyPath: storageKeyPath].storage
        }
        set {
